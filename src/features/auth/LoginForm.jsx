...
const Button = forwardRef(({ 
  ...
  const sizes = {
    ...
    md: 'px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg min-h-[4rem] sm:min-h-[4.5rem]',
    lg: 'px-8 sm:px-10 py-6 sm:py-7 text-lg sm:text-xl min-h-[4.5rem] sm:min-h-[5.5rem]'
  }
