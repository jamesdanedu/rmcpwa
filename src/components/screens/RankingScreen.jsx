...
export default function VoteScreen() {
  ...
  return (
    <div className="flex flex-col h-full min-h-[calc(100vh-180px)] pb-safe">
      {/* Stats Header - compact but informative */}
      <div className="flex-shrink-0 p-4 pb-2">
        <VotingStats stats={votingStats} />
      </div>
      
      {/* Main Content Area - fills remaining space with safe area padding */}
      <div className="flex-1 p-4 pt-2 pb-6">
        {currentVote ? (
          <VotingCard
            vote={currentVote}
            onVote={handleVote}
